...
const UI = {
    ...
    initSettings() {
        ...
        let tempToken = {}
        try{
            tempToken = JSON.parse(localStorage.getItem('portalApplication'))
        }catch(e) {
        }
        UI.initSetting('path', `/ugreen/v1/docker/app/websockify?name=firefox&token=${tempToken.tk ? tempToken.tk : 'emptyStorage'}`);
    ...
    connect(event, password) {
        ...
        try {
            UI.rfb = new RFB(document.getElementById('noVNC_container'),
                             url.href,
                            // 'ws://192.168.78.31:9999/ugreen/v1/docker/novnc/websockify',

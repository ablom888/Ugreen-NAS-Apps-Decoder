 ...
 *
 * Version: 9.0.3 (build:0)
 */

var g_version="1.0.0-0";var pathnameParts=self.location.pathname.split("/");if(pathnameParts.length>1&&pathnameParts[pathnameParts.length-2])g_version=pathnameParts[pathnameParts.length-2];var g_cacheNamePrefix="document_editor_static_v2_";var g_cacheName=g_cacheNamePrefix+g_version;var patternPrefix=new RegExp(g_version+"/(test-test)");var isDesktopEditor=navigator.userAgent.indexOf("AscDesktopEditor")!==-1;
